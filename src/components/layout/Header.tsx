...
import { Menu, LogOut, User, ChevronDown, Activity, Ticket, Zap, Shield } from 'lucide-react';
            ...
            >
              ...
              <div className="p-2 space-y-1">
                <DropdownMenuItem asChild>
                  <a href="/profile" className="flex w-full items-center px-3 py-2 rounded-lg text-slate-600 hover:text-slate-800 hover:bg-blue-50 transition-all duration-200 group">
