  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative overflow-hidden rounded-lg bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800 p-6 text-white"
      >
          ...
          <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-t-lg pb-3">
            <div className="flex space-x-1">
              <Button
                ...
                className={activeTab === 'all' ? 'bg-indigo-600 hover:bg-indigo-700 text-white' : 'hover:bg-indigo-50'}
              >
              ...
              <Button
                ...
                className={activeTab === 'assigned' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'hover:bg-blue-50'}
              >
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="text-left py-4 px-6 font-semibold text-gray-700">Assigned To</th>
