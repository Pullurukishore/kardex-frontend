            ...
            <CardHeader className="border-b bg-muted/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <CardDescription>Enter the company details and contact information</CardDescription>
                </div>
              </div>
            </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g. Healthcare, Manufacturing, Retail" {...field} className="bg-background" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="State or Province" {...field} className="bg-background" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Postal or ZIP code" {...field} className="bg-background" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Textarea 
                            ...
                            className="min-h-[100px] pl-9 bg-background"
                            {...field} 
                          />
                        </div>
                      </FormControl>
            ...
            <CardHeader className="border-b bg-muted/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <CardDescription>Set up the primary account for this customer</CardDescription>
                </div>
              </div>
            </CardHeader>
